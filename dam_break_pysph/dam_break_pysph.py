...
from pysph.sph.integrator import Integrator #, EulerIntegrator
...
class XSPHCorrection(Equation):
    # def initialize(self, d_idx, d_ux, d_vx):
    #     d_ux[d_idx] = 0
    #     d_vx[d_idx] = 0

    # def loop(self, d_idx, s_idx, s_m, RHOIJ, VIJ, WIJ, d_ux, d_vx):
    #     d_ux[d_idx] = s_m[s_idx] * VIJ[0] * WIJ / RHOIJ
    #     d_vx[d_idx] = s_m[s_idx] * VIJ[1] * WIJ / RHOIJ

    # def post_loop(self, d_idx, d_u, d_v, d_ux, d_vx):
    #     d_ux[d_idx] = d_u[d_idx] - 0.3 * d_ux[d_idx]
    #     d_vx[d_idx] = d_v[d_idx] - 0.3 * d_vx[d_idx]
